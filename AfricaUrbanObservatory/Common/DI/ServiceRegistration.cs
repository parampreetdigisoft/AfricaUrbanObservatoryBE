using AfricaUrbanObservatory.Backgroundjob;
using AfricaUrbanObservatory.Backgroundjob.logging;
using AfricaUrbanObservatory.Common.Implementation;
using AfricaUrbanObservatory.Common.Interface;
using AfricaUrbanObservatory.IServices;
using AfricaUrbanObservatory.Services;

namespace AfricaUrbanObservatory.Common.DI
{
