using AfricaUrbanObservatory.Common.DI;
using AfricaUrbanObservatory.Common.Implementation;
using AfricaUrbanObservatory.Common.Middlware;
...
namespace AfricaUrbanObservatory
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "AfricaUrbanObservatoryApi",
                    Version = "v1"
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "AfricaUrbanObservatoryApi v1");
